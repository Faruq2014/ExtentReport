...
public class TestListener3 implements ITestListener {
	...
	public void onTestSkipped(ITestResult result) {
		...
		String logText = "<b>" + "TEST METHOD: - " + methodName.toUpperCase() + "  SKIPPED" + "</b>";
