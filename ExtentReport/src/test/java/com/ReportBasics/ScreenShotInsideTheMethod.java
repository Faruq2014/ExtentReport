...
public class ScreenShotInsideTheMethod {

	public WebDriver driver;

	@Test
	public void LoginTest() throws IOException {
		ExtentHtmlReporter reporter = new ExtentHtmlReporter("./Reports/ScreenShotInsideTheMethod.html");
		...
		logger.pass("title match",
				MediaEntityBuilder
						.createScreenCaptureFromPath(
								"/C:/Users/Faruq/WorksSpace/ExtentReport/Screenshot/ScreenShotInsideTheMethod.png")
						.build());
		extent.flush();

		ExtentTest logger1 = extent.createTest("title Test");
		logger1.log(Status.FAIL, "Title is not true");
		logger1.fail("title does not match",
				MediaEntityBuilder.createScreenCaptureFromPath("./Screenshot/LoginTest.jpg").build());
		extent.flush();
	}
