...
public class TestWithFullPageScreenShot {
	...
	public void SetupEnvironment() {
		reporter = new ExtentHtmlReporter("./Reports/TestWithFullPageScreenShot.html");
...
// ExtentReports extent; is setting environment with the help of java system class. 
	 ...
	 * System.getProperty("user.dir") + "/Screenshot/" + screenShotName +
	 ...
	 * }
	 * 
	 * public static String getScreenshot2(WebDriver driver, String screenShotName)
